   ...
   return (
      <aside className="basket basket-status">
         ...
         <div className="basket-status__inner">
            <button onClick={onClose} className="basket-status__close-btn" type='button' aria-label="Закрыть корзину">
                  ...
                  {items.map((el, index) => (
                     ...
                     <li className="basket__item" key={el.id || index}>
                        <div className="basket__inner">
                           <img className="basket__img" width={70} height={70} src={el.imageUrl} alt={el.title} />
                        ...
                        <button className="basket__delete" type='button'>
                           <img onClick={() => removeProduct(el)} className="basket__delete-img" src={productRemove} alt="" aria-hidden="true" />
                        </button>
                     </li>
                  ))}
               </ul>
